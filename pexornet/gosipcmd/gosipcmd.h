...
/*
 * Command line interface for gosip io protocol with pexornet library
 * J.Adamczewski-Musch, gsi, 22-May_2014
 * Adapted for pexor network driver interface libpexornet 10-Dec-2015 JAM
 *
 */
...
struct gosip_cmd {
    ...
    pexornet_handle_t* sd_pex;    /** keep socket interface descriptor here*/
