...
struct snull_priv {
        //struc net_device * netdev; /* JAM added for ethtool ops?*/
...
// 	int quota= min(100, *budget); // JAM quota is gone in kernel 3. workaround to compile?
// 	struct sk_buff *skb;
// 	struct snull_priv *priv = netdev_priv(dev);
// 	struct snull_packet *pkt;
//     
...
static void snull_ethtool_get_drvinfo(struct net_device *dev,
                                        struct ethtool_drvinfo *drvinfo)
{
        printk (KERN_NOTICE "snull_ethtool_get_drvinfo...\n");
        strlcpy(drvinfo->driver, "snull", sizeof(drvinfo->driver));
...
static const struct ethtool_ops snull_ethtool_ops = {
        ...
        .get_settings   = snull_ethtool_get_settings,
        .get_drvinfo    = snull_ethtool_get_drvinfo,
        .set_settings   = snull_ethtool_set_settings,
};
...
int snull_init_module(void)
{
	...
	//snull_interrupt = use_napi ? snull_napi_interrupt : snull_regular_interrupt;
        ...
        // JAM throw out napi for kernel 3 test for the moment!
