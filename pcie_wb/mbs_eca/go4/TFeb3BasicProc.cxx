...
//***********************************************************
TFeb3BasicProc::TFeb3BasicProc() : TGo4EventProcessor("Proc"),l_wr_timestamp(0), l_wr_timestamp_prev(0), f_wr_delta_t(0)
{
...
TFeb3BasicProc::TFeb3BasicProc(const char* name) : TGo4EventProcessor(name)
{
  ...
  h_wr_delta_t= MakeTH1('F', "WR_Delta_time", "WR Time difference subsequent events",25000,0,100000,"#Delta t (ns)");
