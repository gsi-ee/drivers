...
//          {
//            /*
//             * if trigger module was not already cleared in f_user_readout
//             * then clear it
//             */
//            if (l_read_stat != TRIG__CLEARED)
//            {
//              *ps_trig->pl_stat_wr = (EV_IRQ_CLEAR);
//              *ps_trig->pl_stat_wr = (FC_PULSE);
//              // signal end of event. common OR of all trigger modules
//              *ps_trig->pl_ctrl_wr = 0x100;    // sets bit 0x100 to 0
//              *ps_trig->pl_stat_wr = (DT_CLEAR);
//      #ifdef DEBUG
//              printf ("\n cleared triggermodule \n");
//      #endif /* DEBUG */
//            }
//          }
//          else
...
//            if (l_tm_vers == 0)
//            {
//      //        printf ("\033[7m m_read_meb: OLD VERSION \033[0m \n");
//              *ps_trig->pl_stat_wr = (IRQ_CLEAR | EV_IRQ_CLEAR);
//              *ps_trig->pl_ctrl_wr = (SLAVE | HALT);
//            }
//            else if (l_tm_vers == 1)
//            {
//      //        printf ("\033[7m m_read_meb: NEW VERSION \033[0m \n");
...
//           *ps_trig->pl_ctrl_wr = CLEAR;
//
//           *ps_trig->pl_stat_wr = 14;
//
//           if ((ps_setup->bh_meb_trig_mode == 3) /* SPECIAL POLLING */
//           && (ps_setup->bh_crate_nr == 0))
//           {
//             *ps_trig->pl_ctrl_wr = GO;
//           }
//           else
//           {
//             *ps_trig->pl_ctrl_wr = (EN_IRQ | GO);
//           }
//
//           ps_daqst->bh_acqui_started = 1;
//
//           F_ERROR(ERR__MSG_INFO, 0, "start acquisition", MASK__PRTTERM);
//         }
//
//
...
//      *ps_trig->pl_ctrl_wr = HALT;
//
//      // the following sleep is very crucial for systems running with
//      // slave processors. it should allow each slave readout task
//      // to finish the last event correctly before the stop acquistion
//      // event is generated by software trigger.
//
//      sleep (2);
//      // check if last hardware trigger/event has really finished
//      // common OR of all trigger modules in system!
//      if (ps_args->l_multi == 1)
//      {
//        while (1)
//        {
//          l_dat = *ps_trig->pl_ctrl_rd;
//          if ((l_dat & 0x100) == 0x100)
//          {
//            printm ("must wait for last trigger/event to finish \n");
//            sleep (1);
//          }
//          else
//          {
...
//        *ps_trig->pl_ctrl_wr = (EN_IRQ | GO);
//      }
//      ps_daqst->bh_acqui_started = 0;
//      F_ERROR(ERR__MSG_INFO, 0, "stop acquisition", MASK__PRTTERM);
//    }
//  }
