// $Id: random-coll.c 478 2009-10-29 12:26:09Z linev $
//-----------------------------------------------------------------------
...
/* converted to cpp version to match the pexorplugin make scheme JAM april-2010*/

#include "pexorplugin/random-coll.h"

//extern double p_dUniform (unsigned int* seed);
//extern double pow (double, double);
//extern double p_dGammaGen (double, unsigned int*);
...
double p_dGammaGen (double A,unsigned int* seed)
//double A;
//unsigned *seed;
{
if (A <= 5)
...
int p_iPoisson(double mu,unsigned int* seed)
//double mu;
//unsigned *seed;
{
double total=1, till;
...
unsigned p_iUniform (unsigned int* seed)
//unsigned *seed;
{
unsigned lo, hi;
...
double p_dUniform(unsigned int* seed)
//unsigned * seed;
{
unsigned lo, hi;
