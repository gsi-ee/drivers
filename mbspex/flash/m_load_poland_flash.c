...
void f_usage (const char *progname)
{
  ...
  printf ("%s <sfp id> <first poland id> <# of poland> <bitfile input fn> \n", progname);
  printf ("%s <sfp id> <first poland id> <# of poland> <bitfile input fn> -nv \n", progname);
  printf ("%s <sfp id> <first poland id> <# of poland> <bitfile input fn> -ec\n", progname);
  printf ("%s <sfp id> <first poland id> <# of poland> <bitfile input fn> -ec -nv \n", progname);
  printf ("%s <sfp id> <first poland id> <# of poland> <bitfile input fn> -vo \n", progname);
  printf ("\n");
