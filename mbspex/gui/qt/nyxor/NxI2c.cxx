...
int nxyter::NxI2c::getRegisterArray(uint8_t reg, uint8_t *val, int nreg)
{
  for (int i=0; i<nreg; i++) {
...
int nxyter::NxI2c::setMailboxRegister(uint8_t reg, const uint8_t *val, int nval)
{
...
int nxyter::NxI2c::getMailboxRegister(uint8_t reg, uint8_t *val, int nval)
{
  for (int i=0; i<nval; i++) {
